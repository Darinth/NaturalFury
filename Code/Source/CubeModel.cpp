...
CubeModel::CubeModel(GraphicsEngine *graphicsEngine, const glm::vec3& halfExtents,
	...
	shared_ptr<GraphicsEngineTexture> southTexture, shared_ptr<GraphicsEngineTexture> westTexture, shared_ptr<GraphicsEngineTexture> bottomTexture) : graphicsEngine(graphicsEngine)
{
